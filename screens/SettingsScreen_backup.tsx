...
import { RouterConfig } from '../types/Device';
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        <View style={styles.card}>
          <Text style={styles.cardTitle}>Router Configuration</Text>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.switchContainer}>
            <Text style={styles.label}>Use Mock Data (when router offline)</Text>
            <Switch
              value={useMockData}
        ...
        <View style={styles.appInfoCard}>
          <Text style={styles.appName}>Xfinity Router Manager</Text>
